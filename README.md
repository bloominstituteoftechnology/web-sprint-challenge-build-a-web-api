...
express- is a framework that gives you the ability to create web applications alongside node.js

node- is a runtime enviroment, a platform that is used to execute javascript applications outside of the browser

1. Understand and explain the use of Middleware?
middleware is functions that exectute actions.
an array of functions
1. The basic principles of the REST architectural style.
Representational State Transfer
1.) contract first approach/ uniform
2.) Statelessness
...
a way to split an application into sub-applications to make it more modular and easier to maintain.

1. Describe tooling used to manually test the correctness of an API.

To test a api a tool you can use is Postman to test GET/POST/PUT/DELETE requests
