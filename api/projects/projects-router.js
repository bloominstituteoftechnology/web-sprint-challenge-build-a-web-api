...
//middleware
//const { functions to import go here } = require('../middleware.js);
...
router.get('/api/projects/:id', (req, res) => {
    projects.get(id)
        ...
        .catch(error => {
            console.log(error);
            res.status(500).json({message: 'Error finding specific id'});
        });
});
...
//   - If there is no project with the given `id` it responds with a status code 404.
//   - If the request body is missing any of the required fields it responds with a status code 400.
router.put('/api/projects/:id', /*middleware functions*/(req, res) => {
